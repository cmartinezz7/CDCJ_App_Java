...
public class ListaMovimientosResponseEnvelope extends GlobalReponseEnvelope {
    @Element(name = "Body", required = false)
    private ListaMovimientoResponseBody body;

    public ListaMovimientoResponseBody getBody() {
        return this.body;
    }
}

...
public class BusquedaExpedientesVacia extends MainActivity {
    private Context context;
    private Button nuevaBusqueda;
    private TextView tvUserName;

    /* JADX WARNING: type inference failed for: r9v0, types: [es.santander.justicia.minisJusticia.common.activity.MainActivity, android.content.Context, com.google.android.material.navigation.NavigationView$OnNavigationItemSelectedListener, es.santander.justicia.minisJusticia.BusquedaExpedientesVacia] */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((QFontTextView) findViewById(R.id.bar_title)).setText(R.string.title_activity_home);
        ...
        this.nuevaBusqueda.setOnClickListener(new View.OnClickListener() {
            /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, es.santander.justicia.minisJusticia.BusquedaExpedientesVacia] */
            public void onClick(View v) {
                BusquedaExpedientesVacia.this.finish();
                BusquedaExpedientesVacia.this.startActivity(new Intent(BusquedaExpedientesVacia.this, BusquedaExpedientesActivity.class));
            }
        });
        ((LinearLayout) findViewById(R.id.close_session)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                BusquedaExpedientesVacia.this.logout();
            }
        });
    }
}

...
public class ContratosConexionResponseEnvelope {
    @Element(name = "Body", required = false)
    private ContratosConexionResponseBody loginUnicoBody;

    public ContratosConexionResponseBody getLoginUnicoBody() {

...
public class BuscarExpedientesArg0Detail {
    @Element(name = "datosAcceso", required = false)
    ...
    public BuscarExpedientesArg0Detail(DatosAcceso datosAcceso2, DatosFiltradoRequest datosFiltradoRequest2, DatosPaginacionRequest datosPaginacionRequest2) {
        this.datosAcceso = datosAcceso2;
        this.datosFiltradoRequest = datosFiltradoRequest2;

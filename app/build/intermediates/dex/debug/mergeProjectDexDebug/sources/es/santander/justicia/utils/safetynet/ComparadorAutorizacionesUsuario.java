...
public class ComparadorAutorizacionesUsuario implements Comparator<AutorizacionesUsuario> {
    ...
    public int compare(AutorizacionesUsuario o1, AutorizacionesUsuario o2) {
        Date date1 = getDate(o1.getFechaInicial());
        Date date2 = getDate(o2.getFechaFinal());
        if (date1 == null || date2 == null) {
            return 0;
        }
        return getDate(o2.getFechaInicial()).compareTo(getDate(o1.getFechaInicial()));
    }
    ...
    public synchronized java.util.Date getDate(java.lang.String r4) {
        ...
        L_0x0029:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: es.santander.justicia.utils.safetynet.ComparadorAutorizacionesUsuario.getDate(java.lang.String):java.util.Date");
    }
}

...
public class DetalleMovimientoTimeLineFragment extends Fragment {
    ...
    public static DetalleMovimientoTimeLineFragment newInstance(MovementItemDTO movementItemDTO2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        DetalleMovimientoTimeLineFragment.super.onCreate(savedInstanceState);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        DetalleMovimientoTimeLineFragment.super.onViewCreated(view, savedInstanceState);
        ...
        list.setAdapter(new TimeLineAdapter(this.context, timeLineList));

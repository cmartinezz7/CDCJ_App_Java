...
public class AutorizacionesUsuarioEnvelope extends GlobalReponseEnvelope {
    @Element(name = "Body", required = false)
    private AutorizacionesUsuarioBody body;

    public AutorizacionesUsuarioBody getBody() {
        return this.body;
    }
}

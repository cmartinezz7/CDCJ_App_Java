...
public class SoapSerializationEnvelope extends SoapEnvelope {
    ...
    public void readVector(XmlPullParser parser, Vector v, PropertyInfo elementType) throws IOException, XmlPullParserException {
        ...
        if (type != null) {
            ...
            String namespace = xmlPullParser.getNamespace(cut0 == -1 ? "" : type.substring(0, cut0));
        ...
        while (parser.getEventType() != 3) {
            ...
            vector.setElementAt(read(parser, v, position2, prefix, name, elementType2), position3);
    ...
    public Object read(XmlPullParser parser, Object owner, int index, String namespace, String name, PropertyInfo expected) throws IOException, XmlPullParserException {
        ...
        if (href == null) {
            ...
            String id = xmlPullParser.getAttributeValue((String) null, "id");
            if (nullAttr == null) {
            ...
            if (nullAttr == null || !SoapEnvelope.stringToBoolean(nullAttr)) {
                ...
                obj2 = readInstance(xmlPullParser, prefix, name2, propertyInfo);
                if (obj2 == null) {
                    obj2 = readUnknown(xmlPullParser, prefix, name2);
                }
            } else {
                parser.nextTag();
        ...
        for (int i = 0; i < cnt; i++) {
            ...
            if (prop instanceof SoapObject) {
                ...
                if (!this.implicitTypes) {
                    writer.attribute(this.xsi, TYPE_LABEL, writer.getPrefix(namespace, true) + ":" + type);
                }
    ...
    public void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (type.multiRef || qName[2] != null) {
            ...
            writer.attribute((String) null, HREF_LABEL, (qName[2] == null ? new StringBuilder().append("#o").append(i) : new StringBuilder().append("#").append(qName[2])).toString());
            return;
        }
        if (!this.implicitTypes || obj.getClass() != type.type) {
            writer.attribute(this.xsi, TYPE_LABEL, writer.getPrefix((String) qName[0], true) + ":" + qName[1]);
        }
    ...
    public void writeArrayListBody(XmlSerializer writer, ArrayList list) throws IOException {
        ...
        for (int i = 0; i < cnt; i++) {
            ...
            if (prop instanceof SoapObject) {
                ...
                if (!this.implicitTypes) {
                    xmlSerializer.attribute(this.xsi, TYPE_LABEL, xmlSerializer.getPrefix(namespace, true) + ":" + type);
                }

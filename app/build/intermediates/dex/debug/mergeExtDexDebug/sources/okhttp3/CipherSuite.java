...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = $$Lambda$CipherSuite$T7Zk1g23kZZYDDk9_CIZkK4G3E.INSTANCE;
    ...
    public static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", KotlinVersion.MAX_COMPONENT_VALUE);
    ...
    public static final CipherSuite TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", Wbxml.LITERAL_A);
    ...
    public static synchronized CipherSuite forJavaName(String javaName2) {
        ...
        synchronized (CipherSuite.class) {
            ...
            if (result == null) {
                result = map.get(secondaryName(javaName2));
                if (result == null) {

...
final class Relay {
    ...
    class RelaySource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:81:?, code lost:
            r5 = java.lang.Math.min(r2, r9 - r11);
        ...
        public long read(okio.Buffer r22, long r23) throws java.io.IOException {
            /*
                ...
                monitor-enter(r4)
            L_0x000b:
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0146 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0146 }
                long r7 = r0.upstreamPos     // Catch:{ all -> 0x0146 }
                r9 = r7
                int r0 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
                r5 = -1
                if (r0 != 0) goto L_0x003a
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0146 }
                boolean r0 = r0.complete     // Catch:{ all -> 0x0146 }
                if (r0 == 0) goto L_0x0020
                monitor-exit(r4)     // Catch:{ all -> 0x0146 }
                return r5
            L_0x0020:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0146 }
                java.lang.Thread r0 = r0.upstreamReader     // Catch:{ all -> 0x0146 }
                if (r0 == 0) goto L_0x002e
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x0146 }
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0146 }
                r0.waitUntilNotified(r5)     // Catch:{ all -> 0x0146 }
                goto L_0x000b
            L_0x002e:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0146 }
                java.lang.Thread r7 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x0146 }
                r0.upstreamReader = r7     // Catch:{ all -> 0x0146 }
                r0 = 1
                monitor-exit(r4)     // Catch:{ all -> 0x0146 }
                r7 = r0
                goto L_0x004d
            L_0x003a:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0146 }
                okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x0146 }
                long r7 = r0.size()     // Catch:{ all -> 0x0146 }
                long r7 = r9 - r7
                long r11 = r1.sourcePos     // Catch:{ all -> 0x0146 }
            ...
            L_0x0098:
                ...
                r16 = r22
                r19 = r5
                r15.copyTo((okio.Buffer) r16, (long) r17, (long) r19)     // Catch:{ all -> 0x0118 }
                ...
                r0.write((okio.Buffer) r11, (long) r13)     // Catch:{ all -> 0x0111 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0111 }
                okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x0111 }
            ...
            L_0x012b:
                long r5 = r9 - r11
                long r5 = java.lang.Math.min(r2, r5)     // Catch:{ all -> 0x0146 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0146 }
                okio.Buffer r11 = r0.buffer     // Catch:{ all -> 0x0146 }
                long r12 = r1.sourcePos     // Catch:{ all -> 0x0146 }
                long r13 = r12 - r7
                r12 = r22
                r15 = r5
                r11.copyTo((okio.Buffer) r12, (long) r13, (long) r15)     // Catch:{ all -> 0x0146 }
                long r11 = r1.sourcePos     // Catch:{ all -> 0x0146 }
                long r11 = r11 + r5
                r1.sourcePos = r11     // Catch:{ all -> 0x0146 }
                monitor-exit(r4)     // Catch:{ all -> 0x0146 }
                return r5
            L_0x0146:
                r0 = move-exception

...
final class Http2Writer implements Closeable {
    ...
    private static void writeMedium(BufferedSink sink2, int i) throws IOException {
        sink2.writeByte((i >>> 16) & KotlinVersion.MAX_COMPONENT_VALUE);
        sink2.writeByte((i >>> 8) & KotlinVersion.MAX_COMPONENT_VALUE);
        sink2.writeByte(i & KotlinVersion.MAX_COMPONENT_VALUE);
    }

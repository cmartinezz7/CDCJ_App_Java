...
public final class PublicSuffixDatabase {
        ...
        while (low3 < high) {
            ...
            while (true) {
                if (expectDot) {
                    ...
                    byte0 = bArr2[currentLabelIndex][currentLabelByteIndex] & KotlinVersion.MAX_COMPONENT_VALUE;
                }
                compareResult = byte0 - (bArr[mid2 + publicSuffixByteIndex] & KotlinVersion.MAX_COMPONENT_VALUE);
                if (compareResult == 0) {
    ...
    private void readTheList() throws java.io.IOException {
        ...
        L_0x000b:
            ...
            okio.Source r2 = okio.Okio.source((java.io.InputStream) r0)
            r1.<init>(r2)

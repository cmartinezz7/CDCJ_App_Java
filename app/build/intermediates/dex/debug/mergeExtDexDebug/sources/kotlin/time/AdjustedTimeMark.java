...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1291getAdjustmentUwyO8pc() {
    ...
    public long m1290elapsedNowUwyO8pc() {
        return Duration.m1334minusLRDsOJo(this.mark.m1383elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1292plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1335plusLRDsOJo(this.adjustment, duration));
    }
}

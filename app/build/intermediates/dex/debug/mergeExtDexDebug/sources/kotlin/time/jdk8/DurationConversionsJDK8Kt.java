...
public final class DurationConversionsJDK8Kt {
    ...
    private static final Duration m1390toJavaDurationLRDsOJo(double $this$toJavaDuration) {
        double $this$iv = $this$toJavaDuration;
        Duration ofSeconds = Duration.ofSeconds((long) kotlin.time.Duration.getInSeconds-impl($this$iv), (long) kotlin.time.Duration.getNanosecondsComponent-impl($this$iv));

...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static boolean m338equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual((Object) sArr, (Object) ((UShortArray) obj).m349unboximpl());
    }
    ...
    public boolean m348containsxj2QHRw(short s) {
        return m336containsxj2QHRw(this.storage, s);
    }

    public boolean containsAll(Collection<? extends Object> collection) {
        return m337containsAllimpl(this.storage, collection);
    }
    ...
    public static short[] m335constructorimpl(short[] storage2) {
        Intrinsics.checkNotNullParameter(storage2, "storage");
        return storage2;
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static short[] m334constructorimpl(int size) {
        return m335constructorimpl(new short[size]);
    }

    /* renamed from: get-Mh2AYeg  reason: not valid java name */
    public static final short m340getMh2AYeg(short[] $this, int index) {
        return UShort.m283constructorimpl($this[index]);
    }

    /* renamed from: set-01HTLdE  reason: not valid java name */
    public static final void m345set01HTLdE(short[] $this, int index, short value) {
        $this[index] = value;
    }

    /* renamed from: getSize-impl  reason: not valid java name */
    public static int m341getSizeimpl(short[] $this) {
        return $this.length;
    }

    /* renamed from: iterator-impl  reason: not valid java name */
    public static java.util.Iterator<UShort> m344iteratorimpl(short[] $this) {
    ...
    private static final class Iterator extends UShortIterator {
        ...
        public short m350nextUShortMh2AYeg() {
            int i = this.index;
            short[] sArr = this.array;
            if (i < sArr.length) {
                this.index = i + 1;
                return UShort.m283constructorimpl(sArr[i]);
            }
    ...
    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public static boolean m336containsxj2QHRw(short[] $this, short element) {
        return ArraysKt.contains($this, element);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m337containsAllimpl(short[] $this, Collection<UShort> elements) {
        Object it;
        ...
        for (Object it2 : $this$all$iv) {
            if (!(it2 instanceof UShort) || !ArraysKt.contains($this, ((UShort) it2).m332unboximpl())) {
                it = null;
                continue;
            } else {
                it = 1;
    ...
    public static boolean m343isEmptyimpl(short[] $this) {

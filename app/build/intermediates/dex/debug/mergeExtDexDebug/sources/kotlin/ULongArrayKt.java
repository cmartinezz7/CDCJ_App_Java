...
public final class ULongArrayKt {
    private static final long[] ULongArray(int size, Function1<? super Integer, ULong> init) {
        ...
        for (int index = 0; index < size; index++) {
            jArr[index] = init.invoke(Integer.valueOf(index)).m228unboximpl();
        }
        return ULongArray.m231constructorimpl(jArr);
    }

    /* renamed from: ulongArrayOf-QwZRm1k  reason: not valid java name */
    private static final long[] m247ulongArrayOfQwZRm1k(long... elements) {
        return elements;
    }
}

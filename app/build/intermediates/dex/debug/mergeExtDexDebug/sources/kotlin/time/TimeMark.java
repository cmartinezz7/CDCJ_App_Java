...
public abstract class TimeMark {
    ...
    public abstract long m1383elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1385plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this, duration, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1384minusLRDsOJo(long duration) {
        return m1385plusLRDsOJo(Duration.m1352unaryMinusUwyO8pc(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1332isNegativeimpl(m1383elapsedNowUwyO8pc());
    }

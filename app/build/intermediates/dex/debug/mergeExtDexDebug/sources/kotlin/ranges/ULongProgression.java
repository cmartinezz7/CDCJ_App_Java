...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m177constructorimpl(j ^ ULong.m177constructorimpl(j >>> 32))) * 31) + ((int) ULong.m177constructorimpl(j2 ^ ULong.m177constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(ULong.m222toStringimpl(this.first)).append("..").append(ULong.m222toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder().append(ULong.m222toStringimpl(this.first)).append(" downTo ").append(ULong.m222toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }

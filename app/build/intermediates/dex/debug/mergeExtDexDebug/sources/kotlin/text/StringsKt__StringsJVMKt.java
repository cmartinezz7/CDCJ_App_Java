...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String $this$replace, String oldValue, String newValue, boolean ignoreCase) {
        ...
        if (newLengthHint >= 0) {
            ...
            int i = 0;
            do {
                stringBuilder.append($this$run, i, occurrenceIndex).append(newValue);
                ...
                if (occurrenceIndex >= $this$run.length() || (occurrenceIndex = StringsKt.indexOf((CharSequence) $this$run, oldValue, occurrenceIndex + searchStep, ignoreCase)) <= 0) {
                    String sb = stringBuilder.append($this$run, i, $this$run.length()).toString();
            ...
            String sb2 = stringBuilder.append($this$run, i, $this$run.length()).toString();

...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(UInt.m144toStringimpl(this.first)).append("..").append(UInt.m144toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder().append(UInt.m144toStringimpl(this.first)).append(" downTo ").append(UInt.m144toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }

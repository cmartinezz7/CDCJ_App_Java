...
public final class DurationKt {
    ...
    private static final long m1380timesmvk6XK0(int $this$times, long duration) {
        return Duration.m1338timesUwyO8pc(duration, $this$times);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m1379timeskIfJnKk(double $this$times, long duration) {
        return Duration.m1337timesUwyO8pc(duration, $this$times);
    }
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1299constructorimpl(normalNanos << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1299constructorimpl((normalMillis << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1299constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }

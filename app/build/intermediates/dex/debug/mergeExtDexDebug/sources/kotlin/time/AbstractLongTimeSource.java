...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public long m1288elapsedNowUwyO8pc() {
            return Duration.m1334minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public TimeMark m1289plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1335plusLRDsOJo(this.offset, duration));
        }
    }

    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1360getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}

    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        ViewCompat.setAccessibilityDelegate(r0, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                MaterialButtonToggleGroup.super.onInitializeAccessibilityNodeInfo(host, info);
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        if (firstVisibleChildIndex != -1) {
            for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
                ...
                int smallestStrokeWidth = Math.min(childButton.getStrokeWidth(), getChildButton(i - 1).getStrokeWidth());

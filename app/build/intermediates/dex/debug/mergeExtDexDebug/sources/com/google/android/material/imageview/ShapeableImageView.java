...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ShapeableImageView.super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    ...
    public void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        ShapeableImageView.super.onSizeChanged(width, height, oldWidth, oldHeight);
    ...
    public void setContentPadding(int left, int top, int right, int bottom) {
        ...
        ShapeableImageView.super.setPadding((ShapeableImageView.super.getPaddingLeft() - this.leftContentPadding) + left, (ShapeableImageView.super.getPaddingTop() - this.topContentPadding) + top, (ShapeableImageView.super.getPaddingRight() - this.rightContentPadding) + right, (ShapeableImageView.super.getPaddingBottom() - this.bottomContentPadding) + bottom);
    ...
    public void setContentPaddingRelative(int start, int top, int end, int bottom) {
        ShapeableImageView.super.setPaddingRelative((ShapeableImageView.super.getPaddingStart() - getContentPaddingStart()) + start, (ShapeableImageView.super.getPaddingTop() - this.topContentPadding) + top, (ShapeableImageView.super.getPaddingEnd() - getContentPaddingEnd()) + end, (ShapeableImageView.super.getPaddingBottom() - this.bottomContentPadding) + bottom);
    ...
    public void setPadding(int left, int top, int right, int bottom) {
        ShapeableImageView.super.setPadding(getContentPaddingLeft() + left, getContentPaddingTop() + top, getContentPaddingRight() + right, getContentPaddingBottom() + bottom);
    }

    public void setPaddingRelative(int start, int top, int end, int bottom) {
        ShapeableImageView.super.setPaddingRelative(getContentPaddingStart() + start, getContentPaddingTop() + top, getContentPaddingEnd() + end, getContentPaddingBottom() + bottom);
    }

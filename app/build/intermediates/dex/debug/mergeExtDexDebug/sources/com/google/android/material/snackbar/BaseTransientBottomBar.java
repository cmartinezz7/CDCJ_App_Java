        ...
        if (parent == null) {
            ...
            ViewCompat.setAccessibilityDelegate(snackbarBaseLayout, new AccessibilityDelegateCompat() {
                public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                    BaseTransientBottomBar.super.onInitializeAccessibilityNodeInfo(host, info);
                ...
                public boolean performAccessibilityAction(View host, int action, Bundle args) {
                    if (action != 1048576) {
                        return BaseTransientBottomBar.super.performAccessibilityAction(host, action, args);
                    }

...
@XmlRootElement(name = "listarFilialesRepos_LAResponse", namespace = "http://www.isban.es/webservices///F_moemc2_contratos_la/internet/ACEMPMOVContratos/v1")
@XmlType(name = "", propOrder = {"methodResult"})
public class ListarFilialesReposLAResponse {

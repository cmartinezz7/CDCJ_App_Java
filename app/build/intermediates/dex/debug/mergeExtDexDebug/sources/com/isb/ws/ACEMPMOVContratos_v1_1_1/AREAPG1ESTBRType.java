...
@XmlType(name = "AREAPG1_EST_BR_Type", propOrder = {"codent", "centalt", "transac", "tpoper", "canalpg", "canalnsu", "meiopg", "nsuest", "dtorigem", "hrorigem", "tpcdcli", "indagend"})
public class AREAPG1ESTBRType {
    ...
    public void setNSUEST(String str) {
        this.nsuest = str;
    }

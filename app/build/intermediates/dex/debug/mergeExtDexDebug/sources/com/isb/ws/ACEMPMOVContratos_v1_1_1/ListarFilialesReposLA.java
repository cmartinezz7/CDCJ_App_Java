...
@XmlRootElement(name = "listarFilialesRepos_LA", namespace = "http://www.isban.es/webservices///F_moemc2_contratos_la/internet/ACEMPMOVContratos/v1")
@XmlType(name = "", propOrder = {"entrada", "repos", "datosConexion", "datosCabecera"})
public class ListarFilialesReposLA {

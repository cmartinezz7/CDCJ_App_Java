...
final class Cam16 {
    ...
    static Cam16 fromIntInViewingConditions(int argb, ViewingConditions viewingConditions) {
        ...
        int green = (65280 & i) >> 8;
        int blue = i & KotlinVersion.MAX_COMPONENT_VALUE;
        ...
        float f26 = p1;
        float f27 = t;
        return new Cam16(hue3, c, j2, q2, m2, ((float) Math.sqrt((double) ((viewingConditions.getC() * alpha) / (viewingConditions.getAw() + 4.0f)))) * 50.0f, jstar2, ((float) Math.cos((double) hueRadians)) * mstar, ((float) Math.sin((double) hueRadians)) * mstar);
    }

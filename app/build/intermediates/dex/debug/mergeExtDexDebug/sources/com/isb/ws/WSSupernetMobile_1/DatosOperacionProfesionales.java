...
@XmlType(name = "datosOperacionProfesionales", propOrder = {"cdconc", "codmon", "codpost", "conc30", "datosActuacionPolicial", "datosAdicionales", "datosExpediente", "datosExpedienteDestino", "datosFirma", "datosInterviniente", "datosJuzgadoPaz", "datosMaterializacion", "datosRepresentante", "desanul", "desautoriza", "desctipomod", "fecreop", "idtipvia", "indres", "jasiento", "jcodpais", "jcodprov", "jcodpza", "jfecanul", "jfecautoriza", "jfeccaduc", "jfecconf", "jfecfirma", "jfecfirmeza", "jfechare", "jimpcaduca", "jimpnomi", "jimppend", "jnors", "jnuoper", "jnuopera", "jobs", "jtipomod", "jusrautoriza", "jusrcaduc", "jusrcanul", "jusrconf", "jusrfirma", "jusrhare", "moneda", "nomvia", "numerosr", "numvia", "nurefc", "pais", "plaza", "provincia", "recurso", "seralfab", "serieYMandamiento", "subtipco", "telefono", "tipmovim", "tipoVia"})
public class DatosOperacionProfesionales {

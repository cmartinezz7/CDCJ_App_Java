...
class BitmapHunter implements Runnable {
    ...
    static Bitmap decodeStream(Source source, Request request) throws IOException {
        ...
        if (calculateSize) {
            ...
            long mark = markStream.savePosition(LockFreeTaskQueueCore.MIN_ADD_SPIN_CAPACITY);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:90:0x02e8  */
    ...
    static android.graphics.Bitmap transformResult(com.squareup.picasso.Request r47, android.graphics.Bitmap r48, int r49) {
        ...
        L_0x02b5:
            goto L_0x02d3
        L_0x02b6:
            if (r9 != r2) goto L_0x02ba
            if (r10 == r3) goto L_0x02b5
        L_0x02ba:

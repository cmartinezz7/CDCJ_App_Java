...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout parent, V child) {
        return new SavedState(BottomSheetBehavior.super.onSaveInstanceState(parent, child), (BottomSheetBehavior<?>) this);
    }

    public void onRestoreInstanceState(CoordinatorLayout parent, V child, Parcelable state2) {
        SavedState ss = (SavedState) state2;
        BottomSheetBehavior.super.onRestoreInstanceState(parent, child, ss.getSuperState());
    ...
    public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, V child, View target, float velocityX, float velocityY) {
        ...
        if (this.state != 3 || BottomSheetBehavior.super.onNestedPreFling(coordinatorLayout, child, target, velocityX, velocityY)) {
            return true;
        }
        return false;
    }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            BottomSheetBehavior.super.writeToParcel(out, flags);
    ...
    private void updateAccessibilityActions() {
        ...
        if (weakReference != null && (child = (View) weakReference.get()) != null) {
            ...
            ViewCompat.removeAccessibilityAction(child, ServiceConnection.DEFAULT_BUFFER_SIZE);

...
public class MaterialToolbar extends Toolbar {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        MaterialToolbar.super.onLayout(changed, left, top, right, bottom);
    ...
    public void setElevation(float elevation) {
        MaterialToolbar.super.setElevation(elevation);
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [android.view.View, com.google.android.material.appbar.MaterialToolbar] */

...
public class ElevationOverlayProvider {
    ...
    public int compositeOverlay(int backgroundColor, float elevation) {
        ...
        int overlayColorOpaque = MaterialColors.layer(ColorUtils.setAlphaComponent(backgroundColor, KotlinVersion.MAX_COMPONENT_VALUE), this.elevationOverlayColor, overlayAlphaFraction);
    ...
    private boolean isThemeSurfaceColor(int color) {
        return ColorUtils.setAlphaComponent(color, KotlinVersion.MAX_COMPONENT_VALUE) == this.colorSurface;
    }
}

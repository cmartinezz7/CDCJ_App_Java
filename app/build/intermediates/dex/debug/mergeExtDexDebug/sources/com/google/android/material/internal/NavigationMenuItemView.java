...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [com.google.android.material.internal.NavigationMenuItemView, android.view.ViewGroup] */
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        AnonymousClass1 r0 = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                NavigationMenuItemView.super.onInitializeAccessibilityNodeInfo(host, info);
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [android.view.View, com.google.android.material.internal.NavigationMenuItemView] */

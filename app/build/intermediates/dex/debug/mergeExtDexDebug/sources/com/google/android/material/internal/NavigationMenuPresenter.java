...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    /* JADX WARNING: type inference failed for: r3v1, types: [com.google.android.material.internal.NavigationMenuView, android.view.ViewGroup] */
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        /* JADX WARNING: type inference failed for: r0v2, types: [android.view.View, com.google.android.material.internal.NavigationMenuItemView] */
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (itemViewType == 0) {
                ...
                ViewCompat.setBackground(r0, NavigationMenuPresenter.this.itemBackground != null ? NavigationMenuPresenter.this.itemBackground.getConstantState().newDrawable() : null);
                ...
                r0.initialize(item.getMenuItem(), 0);
    ...
    private class NavigationMenuViewAccessibilityDelegate extends RecyclerViewAccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            NavigationMenuPresenter.super.onInitializeAccessibilityNodeInfo(host, info);

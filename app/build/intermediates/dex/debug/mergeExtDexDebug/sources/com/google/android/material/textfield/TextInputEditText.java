...
public class TextInputEditText extends AppCompatEditText {
    ...
    public void onAttachedToWindow() {
        ...
        if (layout != null && layout.isProvidingHint() && TextInputEditText.super.getHint() == null && ManufacturerUtils.isMeizuDevice()) {
            setHint("");
        }
    }
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        InputConnection ic = TextInputEditText.super.onCreateInputConnection(outAttrs);
    ...
    public void getFocusedRect(Rect r) {
        TextInputEditText.super.getFocusedRect(r);
    ...
    public boolean getGlobalVisibleRect(Rect r, Point globalOffset) {
        ...
        return TextInputEditText.super.getGlobalVisibleRect(r, globalOffset);
    }

    public boolean requestRectangleOnScreen(Rect rectangle) {
        TextInputLayout textInputLayout = getTextInputLayout();
        if (!shouldUseTextInputLayoutFocusedRect(textInputLayout) || rectangle == null) {
            return TextInputEditText.super.requestRectangleOnScreen(rectangle);
        }
        this.parentRect.set(rectangle.left, rectangle.top, rectangle.right, rectangle.bottom + (textInputLayout.getHeight() - getHeight()));
        return TextInputEditText.super.requestRectangleOnScreen(this.parentRect);
    }

    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        TextInputEditText.super.onInitializeAccessibilityNodeInfo(info);
        TextInputLayout layout = getTextInputLayout();

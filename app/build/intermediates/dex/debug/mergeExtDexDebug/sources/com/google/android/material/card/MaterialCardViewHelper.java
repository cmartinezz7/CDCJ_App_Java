...
class MaterialCardViewHelper {
    ...
    /* JADX WARNING: type inference failed for: r6v1, types: [com.google.android.material.card.MaterialCardView, android.view.View] */
    /* access modifiers changed from: package-private */
    ...
    public void setChecked(boolean checked) {
        Drawable drawable = this.checkedIcon;
        if (drawable != null) {
            drawable.setAlpha(checked ? KotlinVersion.MAX_COMPONENT_VALUE : 0);
        }
    }

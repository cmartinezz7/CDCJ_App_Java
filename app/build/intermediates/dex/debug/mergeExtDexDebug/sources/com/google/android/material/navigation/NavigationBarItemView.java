...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        CharSequence customContentDescription2 = AccessibilityNodeInfoCompat.wrap(info);
        customContentDescription2.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(0, 1, getItemVisiblePosition(), 1, false, isSelected()));
        if (isSelected()) {
            customContentDescription2.setClickable(false);
            customContentDescription2.removeAction(AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_CLICK);
        }
        customContentDescription2.setRoleDescription(getResources().getString(R.string.item_view_role_description));
    }
    ...
    private static class ActiveIndicatorTransform {
        ...
        public float calculateAlpha(float progress, float targetValue) {
            return AnimationUtils.lerp(0.0f, 1.0f, targetValue == 0.0f ? 0.8f : 0.0f, targetValue == 0.0f ? 1.0f : ALPHA_FRACTION, progress);
        }

...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    private final TextInputLayout.OnEditTextAttachedListener dropdownMenuOnEditTextAttachedListener = new TextInputLayout.OnEditTextAttachedListener() {
        /* JADX WARNING: type inference failed for: r2v8, types: [com.google.android.material.internal.CheckableImageButton, android.view.View] */
    ...
    public void initialize() {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            this.accessibilityManager.addTouchExplorationStateChangeListener(new AccessibilityManager.TouchExplorationStateChangeListener() {
                /* JADX WARNING: type inference failed for: r0v8, types: [com.google.android.material.internal.CheckableImageButton, android.view.View] */
    ...
    private void initAnimators() {
        ...
        ValueAnimator alphaAnimator = getAlphaAnimator(ANIMATION_FADE_OUT_DURATION, 1.0f, 0.0f);

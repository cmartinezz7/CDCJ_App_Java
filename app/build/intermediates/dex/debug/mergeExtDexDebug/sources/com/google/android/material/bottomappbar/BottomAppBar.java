...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    /* JADX WARNING: type inference failed for: r11v0, types: [com.google.android.material.bottomappbar.BottomAppBar, android.view.View] */
    ...
    public void setNavigationIcon(Drawable drawable) {
        BottomAppBar.super.setNavigationIcon(maybeTintNavigationIcon(drawable));
    }
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [com.google.android.material.bottomappbar.BottomAppBar, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [com.google.android.material.bottomappbar.BottomAppBar, android.view.View] */
    /* access modifiers changed from: private */
    ...
    /* JADX WARNING: type inference failed for: r8v0, types: [com.google.android.material.bottomappbar.BottomAppBar, android.view.View] */
    /* access modifiers changed from: protected */
    public int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int fabAlignmentMode2, boolean fabAttached2) {
        ...
        for (int i2 = 0; i2 < getChildCount(); i2++) {
            ...
            if ((view.getLayoutParams() instanceof Toolbar.LayoutParams) && (view.getLayoutParams().gravity & 8388615) == 8388611) {
                if (isRtl) {
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        BottomAppBar.super.onLayout(changed, l, t, r, b);
        if (changed) {
            cancelAnimations();
            setCutoutState();
        }
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        /* JADX WARNING: type inference failed for: r6v0, types: [com.google.android.material.bottomappbar.BottomAppBar, android.view.View, java.lang.Object] */
        /* JADX WARNING: Unknown variable types count: 1 */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean onLayoutChild(androidx.coordinatorlayout.widget.CoordinatorLayout r5, com.google.android.material.bottomappbar.BottomAppBar r6, int r7) {
            /*
                r4 = this;
                java.lang.ref.WeakReference r0 = new java.lang.ref.WeakReference
                r0.<init>(r6)
                r4.viewRef = r0
                android.view.View r0 = r6.findDependentView()
                ...
                com.google.android.material.animation.MotionSpec r3 = r2.getShowMotionSpec()
                if (r3 != 0) goto L_0x0034
                int r3 = com.google.android.material.R.animator.mtrl_fab_show_motion_spec
                r2.setShowMotionSpecResource(r3)
            L_0x0034:
                com.google.android.material.animation.MotionSpec r3 = r2.getHideMotionSpec()
                if (r3 != 0) goto L_0x003f
                int r3 = com.google.android.material.R.animator.mtrl_fab_hide_motion_spec
                r2.setHideMotionSpecResource(r3)
            L_0x003f:
                android.view.View$OnLayoutChangeListener r3 = r4.fabLayoutListener
                r2.addOnLayoutChangeListener(r3)
                r6.addFabAnimationListeners(r2)
            L_0x0047:
                r6.setCutoutState()
            L_0x004a:
                r5.onLayoutChild(r6, r7)
                boolean r1 = super.onLayoutChild(r5, r6, r7)
                return r1
            */
        ...
        public boolean onStartNestedScroll(androidx.coordinatorlayout.widget.CoordinatorLayout r2, com.google.android.material.bottomappbar.BottomAppBar r3, android.view.View r4, android.view.View r5, int r6, int r7) {
            /*
                ...
                boolean r0 = super.onStartNestedScroll(r2, r3, r4, r5, r6, r7)
                if (r0 == 0) goto L_0x000e
                r0 = 1
                goto L_0x000f
            L_0x000e:
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof SavedState)) {
            BottomAppBar.super.onRestoreInstanceState(state);
            return;
        }
    ...
    static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            BottomAppBar.super.writeToParcel(out, flags);

...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    /* JADX WARNING: type inference failed for: r8v0, types: [com.google.android.material.textfield.MaterialAutoCompleteTextView, android.view.View] */
    ...
    public <T extends ListAdapter & Filterable> void setAdapter(T adapter) {
        MaterialAutoCompleteTextView.super.setAdapter(adapter);
    ...
    public void onAttachedToWindow() {
        ...
        if (layout != null && layout.isProvidingHint() && MaterialAutoCompleteTextView.super.getHint() == null && ManufacturerUtils.isMeizuDevice()) {
            setHint("");
        }
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        MaterialAutoCompleteTextView.super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    ...
    private int measureContentWidth() {
        ...
        int end = Math.min(adapter.getCount(), Math.max(0, this.modalListPopup.getSelectedItemPosition()) + MAX_ITEMS_MEASURED);

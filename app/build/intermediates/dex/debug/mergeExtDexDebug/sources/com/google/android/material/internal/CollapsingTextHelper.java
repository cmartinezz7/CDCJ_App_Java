...
public final class CollapsingTextHelper {
    ...
    public CollapsingTextHelper(View view2) {
        this.view = view2;
        TextPaint textPaint2 = new TextPaint(Wbxml.EXT_T_1);
    ...
    private float getCollapsedTextLeftBound(int width, int gravity) {
        ...
        return ((gravity & 8388613) == 8388613 || (gravity & 5) == 5) ? this.isRtl ? (float) this.collapsedBounds.left : ((float) this.collapsedBounds.right) - this.collapsedTextWidth : this.isRtl ? ((float) this.collapsedBounds.right) - this.collapsedTextWidth : (float) this.collapsedBounds.left;
    }
    ...
    private float getCollapsedTextRightBound(RectF bounds, int width, int gravity) {
        ...
        return ((gravity & 8388613) == 8388613 || (gravity & 5) == 5) ? this.isRtl ? bounds.left + this.collapsedTextWidth : (float) this.collapsedBounds.right : this.isRtl ? (float) this.collapsedBounds.right : bounds.left + this.collapsedTextWidth;
    }
    ...
    private void calculateBaseOffsets(boolean forceRecalculate) {
        ...
        int i4 = 8388615 & expandedAbsGravity;
        if (i4 == 1) {

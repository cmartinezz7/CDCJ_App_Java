...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public void setContentView(int layoutResId) {
        BottomSheetDialog.super.setContentView(wrapInBottomSheet(layoutResId, (View) null, (ViewGroup.LayoutParams) null));
    }

    /* access modifiers changed from: protected */
    public void onCreate(Bundle savedInstanceState) {
        BottomSheetDialog.super.onCreate(savedInstanceState);
    ...
    public void setContentView(View view, ViewGroup.LayoutParams params) {
        BottomSheetDialog.super.setContentView(wrapInBottomSheet(0, view, params));
    }

    public void setCancelable(boolean cancelable2) {
        BottomSheetDialog.super.setCancelable(cancelable2);
    ...
    public void setCanceledOnTouchOutside(boolean cancel) {
        BottomSheetDialog.super.setCanceledOnTouchOutside(cancel);
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ensureContainerAndBehavior();
        CoordinatorLayout coordinator2 = this.container.findViewById(R.id.coordinator);
        ...
        ViewCompat.setAccessibilityDelegate(this.bottomSheet, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                BottomSheetDialog.super.onInitializeAccessibilityNodeInfo(host, info);
            ...
            public boolean performAccessibilityAction(View host, int action, Bundle args) {
                if (action != 1048576 || !BottomSheetDialog.this.cancelable) {
                    return BottomSheetDialog.super.performAccessibilityAction(host, action, args);
                }
                BottomSheetDialog.this.cancel();
                return true;
            }
    ...
    private static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        private EdgeToEdgeCallback(View bottomSheet, WindowInsetsCompat insetsCompat2) {
            ...
            boolean z = Build.VERSION.SDK_INT >= 23 && (bottomSheet.getSystemUiVisibility() & ConstantsKt.DEFAULT_BUFFER_SIZE) != 0;
    ...
    public static void setLightStatusBar(View view, boolean isLight) {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (isLight) {
                flags = flags2 | ConstantsKt.DEFAULT_BUFFER_SIZE;
            } else {
                flags = flags2 & -8193;
            }

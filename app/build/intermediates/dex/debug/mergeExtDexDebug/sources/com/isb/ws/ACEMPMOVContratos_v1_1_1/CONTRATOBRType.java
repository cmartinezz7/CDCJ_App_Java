...
@XmlType(name = "CONTRATO_BR_Type", propOrder = {"entidadbr", "sucursalbr", "nrocuentabr"})
public class CONTRATOBRType {
    ...
    public String getNROCUENTABR() {
        return this.nrocuentabr;
    }

    public void setNROCUENTABR(String str) {
        this.nrocuentabr = str;
    }
}

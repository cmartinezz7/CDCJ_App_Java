...
final class zztb {
    ...
    public static void zza(Class<?> cls) {
        Class<?> cls2;
        if (!zzrb.class.isAssignableFrom(cls) && (cls2 = zza) != null && !cls2.isAssignableFrom(cls)) {
    ...
    static int zza(List<Long> list) {
        ...
        if (list instanceof zzrz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqn.zzd(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzb(List<Long> list) {
        ...
        if (list instanceof zzrz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqn.zze(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzc(List<Long> list) {
        ...
        if (list instanceof zzrz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqn.zzf(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzd(List<Integer> list) {
        ...
        if (list instanceof zzre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqn.zzk(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zze(List<Integer> list) {
        ...
        if (list instanceof zzre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqn.zzf(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzf(List<Integer> list) {
        ...
        if (list instanceof zzre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqn.zzg(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzg(List<Integer> list) {
        ...
        if (list instanceof zzre) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzqn.zzh(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzb(int i, List<zzsm> list, zzsz zzsz) {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            i2 += zzqn.zzc(i, list.get(i3), zzsz);
        }
        return i2;
    }
    ...
    static <T, FT extends zzqy<FT>> void zza(zzqr<FT> zzqr, T t, T t2) {
        zzqw<FT> zza2 = zzqr.zza((Object) t2);
        if (!zza2.zza.isEmpty()) {
            zzqr.zzb(t).zza(zza2);
        }
    }

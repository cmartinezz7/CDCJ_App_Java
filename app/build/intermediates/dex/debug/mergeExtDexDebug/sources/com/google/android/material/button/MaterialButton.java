...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        MaterialButton.super.onInitializeAccessibilityNodeInfo(info);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof SavedState)) {
            MaterialButton.super.onRestoreInstanceState(state);
            return;
        }
    ...
    public void setSupportBackgroundTintList(ColorStateList tint) {
        if (isUsingOriginalBackground()) {
            ...
            MaterialButton.super.setSupportBackgroundTintList(tint);
        }
    }
    ...
    public void setSupportBackgroundTintMode(PorterDuff.Mode tintMode) {
        if (isUsingOriginalBackground()) {
            ...
            MaterialButton.super.setSupportBackgroundTintMode(tintMode);
        }
    }
    ...
    public void setBackgroundColor(int color) {
        if (isUsingOriginalBackground()) {
            ...
            MaterialButton.super.setBackgroundColor(color);
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        if (!isUsingOriginalBackground()) {
            MaterialButton.super.setBackgroundDrawable(background);
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        MaterialButton.super.onLayout(changed, left, top, right, bottom);
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i1, int i2) {
        MaterialButton.super.onTextChanged(charSequence, i, i1, i2);
        updateIconPosition(getMeasuredWidth(), getMeasuredHeight());
    }
    ...
    public void setElevation(float elevation) {
        MaterialButton.super.setElevation(elevation);
        if (isUsingOriginalBackground()) {
    ...
    public void refreshDrawableState() {
        MaterialButton.super.refreshDrawableState();
        if (this.icon != null) {
    ...
    public void setTextAlignment(int textAlignment) {
        MaterialButton.super.setTextAlignment(textAlignment);
        updateIconPosition(getMeasuredWidth(), getMeasuredHeight());
    }
    ...
    /* JADX WARNING: type inference failed for: r9v0, types: [com.google.android.material.button.MaterialButton, android.view.View] */
    ...
    /* JADX WARNING: type inference failed for: r8v0, types: [android.widget.TextView, com.google.android.material.button.MaterialButton] */
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        int[] drawableState = MaterialButton.super.onCreateDrawableState(extraSpace + 2);
        if (isCheckable()) {
    ...
    public void setPressed(boolean pressed) {
        ...
        MaterialButton.super.setPressed(pressed);
    }
    ...
    static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            MaterialButton.super.writeToParcel(out, flags);

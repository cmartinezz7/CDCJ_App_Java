...
final class Blend {
    ...
    public static int harmonize(int designColor, int sourceColor) {
        ...
        return Hct.from(MathUtils.sanitizeDegrees(fromHct.getHue() + (rotationDirection(fromHct.getHue(), toHct.getHue()) * Math.min(HARMONIZE_PERCENTAGE * MathUtils.differenceDegrees(fromHct.getHue(), toHct.getHue()), HARMONIZE_MAX_DEGREES))), fromHct.getChroma(), fromHct.getTone()).toInt();
    }

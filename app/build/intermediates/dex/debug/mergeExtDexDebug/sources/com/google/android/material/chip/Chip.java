...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public void setElevation(float elevation) {
        Chip.super.setElevation(elevation);
    ...
    /* JADX WARNING: type inference failed for: r9v0, types: [com.google.android.material.chip.Chip, android.view.View, androidx.appcompat.widget.AppCompatCheckBox] */
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        Chip.super.onInitializeAccessibilityNodeInfo(info);
    ...
    private void initMinTouchTarget(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.minTouchTargetSize = (int) Math.ceil((double) a.getDimension(R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) ViewUtils.dpToPx(getContext(), MIN_TOUCH_TARGET_DP))));
        a.recycle();
    }
    ...
    public void onRtlPropertiesChanged(int layoutDirection) {
        Chip.super.onRtlPropertiesChanged(layoutDirection);
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        int[] state = Chip.super.onCreateDrawableState(extraSpace + 2);
        if (isChecked()) {
    ...
    public void setBackground(Drawable background) {
        if (background == getBackgroundDrawable() || background == this.ripple) {
            Chip.super.setBackground(background);
        } else {
            Log.w(TAG, "Do not set the background; Chip manages its own background drawable.");
        }
    }
    ...
    public void setBackgroundDrawable(Drawable background) {
        if (background == getBackgroundDrawable() || background == this.ripple) {
            Chip.super.setBackgroundDrawable(background);
        } else {
    ...
    public void setCompoundDrawables(Drawable left, Drawable top, Drawable right, Drawable bottom) {
        if (left != null) {
            ...
            Chip.super.setCompoundDrawables(left, top, right, bottom);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(int left, int top, int right, int bottom) {
        if (left != 0) {
            ...
            Chip.super.setCompoundDrawablesWithIntrinsicBounds(left, top, right, bottom);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setCompoundDrawablesRelative(Drawable start, Drawable top, Drawable end, Drawable bottom) {
        if (start != null) {
            ...
            Chip.super.setCompoundDrawablesRelative(start, top, end, bottom);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int start, int top, int end, int bottom) {
        if (start != 0) {
            ...
            Chip.super.setCompoundDrawablesRelativeWithIntrinsicBounds(start, top, end, bottom);
        } else {
            throw new UnsupportedOperationException("Please set end drawable using R.attr#closeIcon.");
        }
    }
    ...
    public void setSingleLine(boolean singleLine) {
        if (singleLine) {
            Chip.super.setSingleLine(singleLine);
            return;
        }
        throw new UnsupportedOperationException("Chip does not support multi-line text");
    }
    ...
    public void setMinLines(int minLines) {
        if (minLines <= 1) {
            Chip.super.setMinLines(minLines);
            return;
        }
        throw new UnsupportedOperationException("Chip does not support multi-line text");
    }
    ...
    public void setMaxLines(int maxLines) {
        if (maxLines <= 1) {
            Chip.super.setMaxLines(maxLines);
            return;
        }
        throw new UnsupportedOperationException("Chip does not support multi-line text");
    }
    ...
    public void setMaxWidth(int maxWidth) {
        Chip.super.setMaxWidth(maxWidth);
        ChipDrawable chipDrawable2 = this.chipDrawable;
        if (chipDrawable2 != null) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent r7) {
        ...
        L_0x003f:
            ...
            boolean r5 = com.google.android.material.chip.Chip.super.onTouchEvent(r7)
    ...
    public boolean onHoverEvent(MotionEvent event) {
        ...
        return Chip.super.onHoverEvent(event);
    }

    /* access modifiers changed from: protected */
    public boolean dispatchHoverEvent(MotionEvent event) {
        if (!this.touchHelperEnabled) {
            return Chip.super.dispatchHoverEvent(event);
        }
        return this.touchHelper.dispatchHoverEvent(event) || Chip.super.dispatchHoverEvent(event);
    }

    public boolean dispatchKeyEvent(KeyEvent event) {
        if (!this.touchHelperEnabled) {
            return Chip.super.dispatchKeyEvent(event);
        }
    ...
    public void onFocusChanged(boolean focused, int direction, Rect previouslyFocusedRect) {
        Chip.super.onFocusChanged(focused, direction, previouslyFocusedRect);
        if (this.touchHelperEnabled) {
    ...
    public void setLayoutDirection(int layoutDirection) {
        if (this.chipDrawable != null && Build.VERSION.SDK_INT >= 17) {
            Chip.super.setLayoutDirection(layoutDirection);
        }
    }
    ...
    public void setText(CharSequence text, TextView.BufferType type) {
        ...
        if (chipDrawable2 != null) {
            ...
            Chip.super.setText(chipDrawable2.shouldDrawText() ? null : text, type);
    ...
    public void setTextAppearance(Context context, int resId) {
        Chip.super.setTextAppearance(context, resId);
        ChipDrawable chipDrawable2 = this.chipDrawable;
        if (chipDrawable2 != null) {
    ...
    public void setTextAppearance(int resId) {
        Chip.super.setTextAppearance(resId);
        ChipDrawable chipDrawable2 = this.chipDrawable;
        if (chipDrawable2 != null) {
            chipDrawable2.setTextAppearanceResource(resId);
        }

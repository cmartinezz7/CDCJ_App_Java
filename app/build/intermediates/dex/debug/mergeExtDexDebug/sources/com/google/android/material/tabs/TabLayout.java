...
public class TabLayout extends HorizontalScrollView {
    ...
    public void setTabIndicatorAnimationMode(int tabIndicatorAnimationMode2) {
        ...
        } else if (tabIndicatorAnimationMode2 == 2) {
    ...
    public final class TabView extends LinearLayout {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
            ...
            CharSequence customContentDescription = AccessibilityNodeInfoCompat.wrap(info);
            customContentDescription.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(0, 1, this.tab.getPosition(), 1, false, isSelected()));
            if (isSelected()) {
                customContentDescription.setClickable(false);
                customContentDescription.removeAction(AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_CLICK);
            }
            customContentDescription.setRoleDescription(getResources().getString(R.string.item_view_role_description));
        }
    ...
    private int getDefaultHeight() {
        ...
        return (!hasIconAndText || this.inlineLabel) ? DEFAULT_HEIGHT : DEFAULT_HEIGHT_WITH_TEXT_ICON;
    }

...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    /* JADX WARNING: type inference failed for: r1v2, types: [com.google.android.material.chip.Chip, android.view.View] */
    public ChipTextInputComboView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        LayoutInflater inflater = LayoutInflater.from(context);
        ? r1 = (Chip) inflater.inflate(R.layout.material_time_chip, this, false);
        this.chip = r1;
        r1.setAccessibilityClassName("android.view.View");

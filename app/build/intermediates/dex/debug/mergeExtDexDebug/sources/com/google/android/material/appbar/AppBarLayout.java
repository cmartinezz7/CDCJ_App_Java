...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void updateAccessibilityActions(CoordinatorLayout coordinatorLayout, T appBarLayout) {
            ...
            if (scrollingView != null && appBarLayout.getTotalScrollRange() != 0 && (scrollingView.getLayoutParams().getBehavior() instanceof ScrollingViewBehavior)) {
        ...
        private boolean shouldJumpElevationState(CoordinatorLayout parent, T layout) {
            ...
            for (int i = 0; i < size; i++) {
                ScrollingViewBehavior behavior = dependencies.get(i).getLayoutParams().getBehavior();
                if (behavior instanceof ScrollingViewBehavior) {
                    return behavior.getOverlayTop() != 0;
                }
            }
            return false;
        }
        ...
        /* JADX WARNING: type inference failed for: r2v0, types: [android.os.Parcelable] */
        /* JADX WARNING: Multi-variable type inference failed */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public android.os.Parcelable onSaveInstanceState(androidx.coordinatorlayout.widget.CoordinatorLayout r4, T r5) {
            /*
                r3 = this;
                android.os.Parcelable r0 = super.onSaveInstanceState(r4, r5)
                com.google.android.material.appbar.AppBarLayout$BaseBehavior$SavedState r1 = r3.saveScrollState(r0, r5)
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            public void writeToParcel(Parcel dest, int flags) {
                BaseBehavior.super.writeToParcel(dest, flags);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(View child, View dependency) {
            BaseBehavior ablBehavior = dependency.getLayoutParams().getBehavior();
            if (ablBehavior instanceof BaseBehavior) {
        ...
        private static int getAppBarLayoutOffset(AppBarLayout abl) {
            BaseBehavior behavior = abl.getLayoutParams().getBehavior();

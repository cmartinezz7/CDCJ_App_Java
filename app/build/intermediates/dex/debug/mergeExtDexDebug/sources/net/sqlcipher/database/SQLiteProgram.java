...
public abstract class SQLiteProgram extends SQLiteClosable {
    ...
    SQLiteProgram(SQLiteDatabase db, String sql) {
        ...
        if (prefixSql.equalsIgnoreCase("INSERT") || prefixSql.equalsIgnoreCase("UPDATE") || prefixSql.equalsIgnoreCase("REPLAC") || prefixSql.equalsIgnoreCase("DELETE") || prefixSql.equalsIgnoreCase(BLConstants.SANTANDER_SELECT_REQUEST)) {

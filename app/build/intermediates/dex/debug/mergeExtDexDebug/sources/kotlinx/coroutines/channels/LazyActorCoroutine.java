...
final class LazyActorCoroutine<E> extends ActorCoroutine<E> implements SelectClause2<E, SendChannel<? super E>> {
    ...
    public LazyActorCoroutine(CoroutineContext parentContext, Channel<E> channel, Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> block2) {
    ...
    public Object send(E element, Continuation<? super Unit> continuation) {
        start();
        return super.send(element, continuation);
    }
    ...
    public <R> void registerSelectClause2(SelectInstance<? super R> select, E param, Function2<? super SendChannel<? super E>, ? super Continuation<? super R>, ? extends Object> block2) {
        Intrinsics.checkParameterIsNotNull(select, "select");
        Intrinsics.checkParameterIsNotNull(block2, "block");
        start();
        super.getOnSend().registerSelectClause2(select, param, block2);
    }
}

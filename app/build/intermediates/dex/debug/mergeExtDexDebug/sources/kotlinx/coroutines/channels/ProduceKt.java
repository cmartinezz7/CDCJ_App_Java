...
public final class ProduceKt {
    ...
    public static final <E> ReceiveChannel<E> produce(CoroutineScope $receiver, CoroutineContext context, int capacity, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(block, "block");
        ProducerCoroutine coroutine = new ProducerCoroutine(CoroutineContextKt.newCoroutineContext($receiver, context), ChannelKt.Channel(capacity));
    ...
    public static final <E> ReceiveChannel<E> produce(CoroutineScope $receiver, CoroutineContext context, int capacity, Function1<? super Throwable, Unit> onCompletion, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(context, "context");
        Intrinsics.checkParameterIsNotNull(block, "block");
        ProducerCoroutine coroutine = new ProducerCoroutine(CoroutineContextKt.newCoroutineContext($receiver, context), ChannelKt.Channel(capacity));

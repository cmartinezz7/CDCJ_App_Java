...
public final class ExecutorsKt {
    public static final ExecutorCoroutineDispatcher from(ExecutorService $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        CoroutineDispatcher from = from((Executor) $receiver);
        if (from != null) {
    ...
    public static final CoroutineDispatcher from(Executor $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");

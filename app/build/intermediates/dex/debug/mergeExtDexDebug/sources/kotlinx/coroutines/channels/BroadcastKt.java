...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(ReceiveChannel<? extends E> $receiver, int capacity, CoroutineStart start) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(start, "start");
        return broadcast(GlobalScope.INSTANCE, Dispatchers.getUnconfined(), capacity, start, ChannelsKt.consumes($receiver), new BroadcastKt$broadcast$1($receiver, (Continuation) null));
    }
    ...
    public static /* synthetic */ BroadcastChannel broadcast$default(CoroutineScope coroutineScope, CoroutineContext coroutineContext, int i, CoroutineStart coroutineStart, Function1 function1, Function2 function2, int i2, Object obj) {
        ...
        CoroutineContext coroutineContext2 = (i2 & 1) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext;
        if ((i2 & 2) != 0) {
            i3 = 1;
        } else {
            i3 = i;
    ...
    public static final <E> BroadcastChannel<E> broadcast(CoroutineScope $receiver, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> onCompletion, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {

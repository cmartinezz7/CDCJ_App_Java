...
public final class LockFreeLinkedListKt {
    ...
    public static final LockFreeLinkedListNode unwrap(Object $receiver) {
        LockFreeLinkedListNode lockFreeLinkedListNode;
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Removed removed = (Removed) (!($receiver instanceof Removed) ? null : $receiver);
        return (removed == null || (lockFreeLinkedListNode = removed.ref) == null) ? (LockFreeLinkedListNode) $receiver : lockFreeLinkedListNode;
    }
}

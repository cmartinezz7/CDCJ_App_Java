...
final /* synthetic */ class JobKt__FutureKt {
    ...
    public static final void cancelFutureOnCancellation(CancellableContinuation<?> $receiver, Future<?> future) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        Intrinsics.checkParameterIsNotNull(future, "future");
        $receiver.invokeOnCancellation(new CancelFutureOnCancel(future));
    }
}

...
public final class CompletionHandlerKt {
    public static final Function1<Throwable, Unit> getAsHandler(CompletionHandlerBase $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        return $receiver;
    }

    public static final Function1<Throwable, Unit> getAsHandler(CancelHandlerBase $receiver) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
        return $receiver;
    }

    public static final void invokeIt(Function1<? super Throwable, Unit> $receiver, Throwable cause) {
        Intrinsics.checkParameterIsNotNull($receiver, "receiver$0");
